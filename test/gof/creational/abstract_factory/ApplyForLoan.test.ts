import { MortgageLoanFactory } from "../../../../src/gof/creational/abstract_factory/factory/LoanFactory";
import { RepositoryMemoryFactory } from "../../../../src/gof/creational/abstract_factory/repository/RepositoryFactory";
import ApplyForLoan from "../../../../src/gof/creational/abstract_factory/use-case/ApplyForLoan";
import GetLoan from "../../../../src/gof/creational/abstract_factory/use-case/GetLoan";
...
test("Deve solicitar um financiamento imobiliário", async function () {
	...
	const outputApplyForLoan = await applyForLoan.execute({
		amount: 100000, 
		income: 10000, 
		installments: 240
	});
